...
const Skills = ({ power }) => {
  ...
  return (
    <div className='py-6'>
      <div className='text-xl md:text-2xl font-medium container mx-auto px-8'>
        My Skills
      </div>
          ...
          <Marquee pauseOnHover autoFill>
            {power.map((item, index) => {
              ...
              return (
                <div
                  key={index}
                  className='flex pr-3 items-center bg-teal-300 dark:bg-stone-900 m-4 text-md rounded-lg hover:underline shadow-none transition-shadow hover:shadow-md dark:hover:shadow-md-dark hover:cursor-pointer'
                >
                  <img
